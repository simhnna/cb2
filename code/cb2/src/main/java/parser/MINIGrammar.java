...
public class MINIGrammar implements MINIGrammarConstants {
    ...
    final public MethodNode method(Token name, Type type) throws ParseException {
        ...
        {
            if (true)
                return new MethodNode(name, type, arguments, body);
        }
        throw new Error("Missing return statement in function");
    }
    ...
    final public StatementNode simpleStatement() throws ParseException {
        ...
        case SEMICOLON:
            jj_consume_token(SEMICOLON); {
            if (true)
                return new SimpleStatementNode(first);
        }
            break;
        case ASSIGNMENT:
            ...
            jj_consume_token(SEMICOLON); {
            if (true)
                return new AssignmentStatementNode(first, second);
        }
            break;
        default:
            jj_la1[7] = jj_gen;
    ...
    final public ExpressionNode atomicExpression() throws ParseException {
        ...
        case ID:
            ...
            if (arguments == null) {
                {
                    if (true)
                        return new FieldMemberExpressionNode(null, name);
                }
            } {
            if (true)
                return new MethodInvocationExpressionNode(null, name, arguments);
        }
            break;
        case THIS:
            jj_consume_token(THIS); {
            if (true)
                return new ThisAtomicExpressionNode(token);
        }
            break;
        case STRING:
            jj_consume_token(STRING); {
            if (true)
                return new StringAtomicExpressionNode(token);
        }
            break;
        case INT:
            jj_consume_token(INT); {
            if (true)
                return new IntAtomicExpressionNode(token);
        }
            break;
        case BOOL:
            jj_consume_token(BOOL); {
            if (true)
                return new BoolAtomicExpressionNode(token);
        }
            break;
        case NULL:
            n = nullExpression();
        ...
        case PARAN_OPEN:
            ...
            jj_consume_token(PARAN_CLOSE); {
            if (true)
                return new PriorityExpressionNode(expression);
        }
            break;
        default:
            jj_la1[27] = jj_gen;
    ...
    private static void jj_la1_init_0() {
        jj_la1_0 = new int[] { 0x400, 0x0, 0x82000, 0x8000, 0x40000, 0x0, 0x35f12800, 0x8080000, 0x35f12800, 0x2000000,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x50000000, 0x50000000, 0x80000000, 0x80000000, 0x30000000, 0x30312000,
                0x20000, 0x2000, 0x40000, 0x30312000, 0x2000, 0x312000, 0x40000, 0x0, };
    }

    private static void jj_la1_init_1() {
        jj_la1_1 = new int[] { 0x0, 0x400, 0x0, 0x0, 0x0, 0x400, 0x3c00, 0x0, 0x3c00, 0x0, 0x200, 0x100, 0xc, 0xc, 0xf0,
                0xf0, 0x0, 0x0, 0x3, 0x3, 0x0, 0x3c00, 0x0, 0x0, 0x0, 0x3c00, 0x0, 0x3c00, 0x0, 0xc00, };
    }
